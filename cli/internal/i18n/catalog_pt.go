...
var catalogPT = map[string]string{
	...
	"cmd.update.short":           "Atualiza o que o projeto puxa do upstream (skills, SDK, design system, grafo)",
	"cmd.update.skills.short":    "Reinstala as skills dos agentes a partir da fonte configurada",
	"cmd.update.sdk.short":       "Atualiza o checkout do SDK e suas docs para a versão fixada",
	"cmd.update.ds.short":        "Atualiza as docs de design system de cada surface de frontend",
	"cmd.update.graph.short":     "Reconstrói o grafo de código e reinstala os hooks git",
	"cmd.update.inst.short":      "Espelha a base de negócio a partir do repo institucional da organização",
	"cmd.update.audit.short":     "Reporta o que ficou para trás; não altera nada",
