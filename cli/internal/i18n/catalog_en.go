...
var catalogEN = map[string]string{
	...
	"cmd.update.short":           "Update what the project pulls from upstream (skills, SDK, design system, graph)",
	"cmd.update.skills.short":    "Reinstall the agent skills from the configured source",
	"cmd.update.sdk.short":       "Update the SDK checkout and its docs to the pinned release",
	"cmd.update.ds.short":        "Update the design-system docs of every front-end surface",
	"cmd.update.graph.short":     "Rebuild the code graph and reinstall its git hooks",
	"cmd.update.inst.short":      "Mirror the business base from the org's institutional repo",
	"cmd.update.audit.short":     "Report what drifted; change nothing",
